...
VALUES 
    ('Evolution API', 'evolution_api', '{"url": "", "api_key": "", "webhook_url": ""}', false),
    ('n8n Automation', 'n8n', '{"url": "", "webhook_token": ""}', false)
...
COMMENT ON COLUMN impaai.integrations.is_active IS 'Status da integração (ativa/inativa)';
